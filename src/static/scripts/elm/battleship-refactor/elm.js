...
Elm.Battleship.make = function (_elm) {
   ...
   grid) {
      return function () {
         var gridW = $Matrix.width(grid);
         var gridH = $Matrix.height(grid);
         var isInBounds = function (_v1) {
            return function () {
               switch (_v1.ctor)
               {case "_Tuple2":
                  return _U.cmp(_v1._0,
                    0) > -1 && (_U.cmp(_v1._0,
                    gridH) < 0 && (_U.cmp(_v1._1,
                    0) > -1 && _U.cmp(_v1._1,
                    gridW) < 0));}
               _U.badCase($moduleName,
   ...
   var shipOverlaps = F3(function (ship,
   grid,
   ships) {
      return function () {
         var shipCoordinates = getShipCoordinates(ship);
         return A2($List.foldr,
         F2(function (coord,acc) {
            return A2($List.member,
            coord,
            shipCoordinates) || acc;
         }),
         false)($List.concat($List.map(getShipCoordinates)($Dict.values($Dict.filter(F2(function (key,
         v) {
            return v.added;
         }))(ships)))));
      }();
   });
   var canAddShip = F3(function (ship,
   grid,
   ships) {
      return $Basics.not(A2(shipInBounds,
      ship,
      grid)) ? false : A3(shipOverlaps,
      ship,
      grid,
      ships) ? false : true;
   });
   var addShip = F2(function (shipId,
   thePlayer) {
      return function () {
         var updateShip = function (maybeShip) {
            return $Maybe.map(function (theShip) {
               return _U.replace([["added"
                                  ,A3(canAddShip,
                                  theShip,
                                  thePlayer.primaryGrid,
                                  thePlayer.ships)]],
               theShip);
            })(maybeShip);
         };
         return _U.replace([["ships"
                            ,A3($Dict.update,
                            shipId,
                            updateShip,
                            thePlayer.ships)]],
   ...
   $default) {
      ...
      "") ? 0 : function () {
         var _v5 = $String.toInt(stringToConvert);
         switch (_v5.ctor)
         {case "Ok": return _v5._0;}
         return $default;
      }();
   });
   var PlayShoot = {ctor: "PlayShoot"};
   var SetupAddShip = function (a) {
      return {ctor: "SetupAddShip"
             ,_0: a};
   };
   var SetupColumnField = F2(function (a,
   b) {
      return {ctor: "SetupColumnField"
             ,_0: a
             ,_1: b};
   });
   var SetupRowField = F2(function (a,
   b) {
      return {ctor: "SetupRowField"
             ,_0: a
             ,_1: b};
   });
   var SetupOrientationField = function (a) {
      return {ctor: "SetupOrientationField"
             ,_0: a};
   };
   var DefaultCell = {ctor: "DefaultCell"};
   var defaultGrid = A3($Matrix.repeat,
   10,
   10,
   DefaultCell);
   var MissCell = {ctor: "MissCell"};
   var HitCell = {ctor: "HitCell"};
   ...
   var defaultShips = $Dict.fromList(_L.fromArray([{ctor: "_Tuple2"
                                                   ,_0: 1
                                                   ,_1: A5(Ship,
                                                   2,
                                                   Horizontal,
                                                  ...
                                                  ,{ctor: "_Tuple2"
                                                   ...
                                                   0,
                                                   false)}]));
   var shipFieldView = F3(function (address,
   shipId,
   theShip) {
      return $Basics.not(theShip.added) ? A2($Html.div,
      _L.fromArray([]),
      _L.fromArray([A2($Html.input,
                   _L.fromArray([$Html$Attributes.value($Basics.toString(theShip.row))
                                ,A3($Html$Events.on,
                                "input",
                                $Html$Events.targetValue,
                                function ($) {
                                   return $Signal.message(address)(SetupRowField(shipId)($));
                                })]),
                   _L.fromArray([]))
                   ,A2($Html.input,
                   _L.fromArray([$Html$Attributes.value($Basics.toString(theShip.column))
                                ,A3($Html$Events.on,
                                "input",
                                $Html$Events.targetValue,
                                function ($) {
                                   return $Signal.message(address)(SetupColumnField(shipId)($));
                                })]),
                   _L.fromArray([]))
                   ,A2($Html.input,
                   _L.fromArray([$Html$Attributes.type$("radio")
                                ,$Html$Attributes.checked(_U.eq(theShip.orientation,
                                Horizontal))
   ...
   thePlayer) {
      return function () {
         var theHtml = $List.map(function (_v7) {
            return function () {
               switch (_v7.ctor)
               {case "_Tuple2":
                  return A3(shipFieldView,
                    address,
                    _v7._0,
                    _v7._1);}
               _U.badCase($moduleName,
               "on line 101, column 45 to 81");
            }();
         })($Dict.toList(thePlayer.ships));
         return A2($Html.div,
         _L.fromArray([]),
         A2($Basics._op["++"],
         theHtml,
         _L.fromArray([$Html.text($Basics.toString(thePlayer.ships))])));
      }();
   });
   ...
   var toggleOrientation = function (orientation) {
      return _U.eq(orientation,
      ...
      return function () {
         ...
         {case "SetupAddShip":
            return _U.replace([["player"
                               ...
                               model.player)]],
              model);
            case "SetupColumnField":
            return function () {
                 var updateShip = function (maybeShip) {
                    return $Maybe.map(function (theShip) {
                       return _U.replace([["column"
            ...
            case "SetupOrientationField":
            return function () {
                 var updateShip = function (maybeShip) {
                    return $Maybe.map(function (theShip) {
                       return _U.replace([["orientation"
                                          ,toggleOrientation(theShip.orientation)]],
                       theShip);
                    })(maybeShip);
                 };
                 var thePlayer = model.player;
   ...
   _elm.Battleship.values = {_op: _op
                            ...
                            ,shipFieldView: shipFieldView
                            ,SetupOrientationField: SetupOrientationField
                            ,SetupRowField: SetupRowField
                            ,SetupColumnField: SetupColumnField
                            ,SetupAddShip: SetupAddShip
                            ,PlayShoot: PlayShoot
                            ,update: update
                            ...
                            ,shipOverlaps: shipOverlaps
                            ,shipInBounds: shipInBounds
...
Elm.Matrix.make = function (_elm) {
   ...
   var map2 = F3(function (f,a,b) {
      return _U.eq(a.size,
      b.size) ? $Maybe.Just(_U.replace([["data"
                                        ,$Array.fromList(A3($List.map2,
                                        f,
                                        $Array.toList(a.data),
                                        $Array.toList(b.data)))]],
      a)) : $Maybe.Nothing;
   ...
   matrix) {
      return _U.replace([["data"
                         ,A2($Array.map,f,matrix.data)]],
      matrix);
   });
   var concatVertical = F2(function (a,
   b) {
      return !_U.eq($Basics.fst(a.size),
      $Basics.fst(b.size)) ? $Maybe.Nothing : $Maybe.Just(_U.replace([["size"
                                                                      ,{ctor: "_Tuple2"
   ...
   matrix) {
      return function () {
         ...
         _L.range(0,height - 1));
         return _U.cmp(i,
         width) > -1 ? $Maybe.Nothing : $Maybe.Just($Array.fromList(A2($List.map,
         function (index) {
            return function () {
   ...
   var fromList = function (list) {
      return function () {
         ...
         return $Basics.not(allSame) ? $Maybe.Nothing : $Maybe.Just({_: {}
   ...
   var get = F3(function (i,
   j,
   matrix) {
      return function () {
         var pos = j * width(matrix) + i;
         return _U.cmp(i,
         width(matrix)) < 0 && _U.cmp(i,
         -1) > 0 && (_U.cmp(j,
         height(matrix)) < 0 && _U.cmp(j,
         -1) > 0) ? A2($Array.get,
         pos,
         matrix.data) : $Maybe.Nothing;
      }();
   });
   var getRow = F2(function (j,
   matrix) {
      return function () {
   ...
   var concatHorizontal = F2(function (a,
   b) {
      return function () {
         ...
         $Basics.snd(b.size)) ? $Maybe.Nothing : $Maybe.Just(_U.replace([["size"
                                                                         ,{ctor: "_Tuple2"
                                                                          ,_0: finalWidth
                                                                          ,_1: $Basics.snd(a.size)}]
                                                                        ,["data"
                                                                         ,A2($List.foldl,
                                                                         F2(function (_v6,
                                                                         acc) {
   ...
   matrix) {
      return function () {
         ...
         return _U.cmp(i,
         width(matrix)) < 0 && _U.cmp(j,
         height(matrix)) < 0 ? _U.replace([["data"
                                           ,A3($Array.set,
                                           pos,
                                           v,
                                           matrix.data)]],
   ...
   matrix) {
      return function () {
         ...
         return _U.replace([["data"
                            ,$Array.fromList($List.indexedMap(f$)($Array.toList(matrix.data)))]],
         matrix);
      }();
   });
