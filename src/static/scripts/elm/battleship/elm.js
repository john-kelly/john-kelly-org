...
Elm.Battleship = Elm.Battleship || {};
Elm.Battleship.make = function (_elm) {
   "use strict";
   _elm.Battleship = _elm.Battleship || {};
   if (_elm.Battleship.values)
   return _elm.Battleship.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   var isGameOver = function (theGame) {
      return function () {
         var isNotSafeCell = function (cell) {
            return function () {
               switch (cell.ctor)
         ...
         var player2Lost = A2($List.foldr,
         F2(function (x,y) {
            return x && y;
         }),
         true)($List.map(isNotSafeCell)($Matrix.flatten(theGame.player2.grid)));
         var player1Lost = A2($List.foldr,
         F2(function (x,y) {
            return x && y;
         }),
         true)($List.map(isNotSafeCell)($Matrix.flatten(theGame.player1.grid)));
         return player1Lost ? {ctor: "_Tuple2"
                              ,_0: true
                              ,_1: "Game Over. Player 2 Wins!"} : player2Lost ? {ctor: "_Tuple2"
                                                                                ,_0: true
                                                                                ,_1: "Game Over. Player 1 Wins!"} : {ctor: "_Tuple2"
                                                                                                                    ,_0: false
                                                                                                                    ,_1: ""};
      }();
   };
   var allButOneShipAdded = function (ships) {
      return F2(function (x,y) {
         return _U.eq(x,y);
      })(1)($List.length($List.filter(function ($) {
         return $Basics.not($Basics.identity($));
   ...
   var trackingGridCellToString = function (gridCell) {
      return function () {
         switch (gridCell.ctor)
         {case "Hit": return "!";
            case "Miss": return "!=";}
         return " ";
      }();
   };
   var trackingGridToString = function (grid) {
      return A2($Matrix.toString,
      trackingGridCellToString,
      {_: {}
      ,delimit: _U.chr(" ")
      ,width: 3})(grid);
   };
   var primaryGridCellToString = function (gridCell) {
      return function () {
         switch (gridCell.ctor)
         {case "Empty": return " ";
            case "Hit": return "!";
   ...
   var primaryGridToString = function (grid) {
      return A2($Matrix.toString,
      primaryGridCellToString,
      {_: {}
      ,delimit: _U.chr(" ")
      ,width: 3})(grid);
   };
   var gridView = F2(function (player,
   gridType) {
      return function () {
         var myStyle = $Html$Attributes.style(_L.fromArray([{ctor: "_Tuple2"
                                                           ...
                                                           ,{ctor: "_Tuple2"
                                                            ...
                                                            ,_1: "5px"}]));
         return function () {
            switch (gridType.ctor)
            {case "PrimaryGrid":
               return A2($Html.div,
                 _L.fromArray([myStyle]),
                 _L.fromArray([$Html.text("Primary Grid")
                              ,A2($Html.pre,
                              _L.fromArray([]),
                              _L.fromArray([$Html.text(primaryGridToString(player.grid))]))]));
               case "TrackingGrid":
               return A2($Html.div,
                 _L.fromArray([myStyle]),
                 _L.fromArray([$Html.text("Tracking Grid")
                              ,A2($Html.pre,
                              _L.fromArray([]),
   ...
   var getShipCoordinates = function (ship) {
      return function () {
         var _v10 = ship.orientation;
         switch (_v10.ctor)
         {case "Horizontal":
   ...
   var SetupShootColumn = function (a) {
      return {ctor: "SetupShootColumn"
             ,_0: a};
   };
   var SetupShootRow = function (a) {
      return {ctor: "SetupShootRow"
             ,_0: a};
   };
   var playControlsView = F3(function (address,
   p,
   theGame) {
      return A2($Html.div,
      _L.fromArray([]),
      _L.fromArray([A2($Html.input,
                   _L.fromArray([$Html$Attributes.value($Basics.toString(theGame.shootRow))
                                ,A3($Html$Events.on,
                                "input",
                                $Html$Events.targetValue,
                                function ($) {
                                   return $Signal.message(address)(SetupShootRow($));
                                })]),
                   _L.fromArray([]))
                   ,A2($Html.input,
                   _L.fromArray([$Html$Attributes.value($Basics.toString(theGame.shootColumn))
                                ,A3($Html$Events.on,
                                "input",
                                $Html$Events.targetValue,
                                function ($) {
                                   return $Signal.message(address)(SetupShootColumn($));
                                })]),
                   _L.fromArray([]))
                   ,A2($Html.button,
   ...
   b) {
      return {ctor: "SetupShipColumn"
             ,_0: a
             ,_1: b};
   });
   var SetupShipRow = F2(function (a,
   b) {
   ...
   var PlayPlayer2 = {ctor: "PlayPlayer2"};
   var PlayPlayer1 = {ctor: "PlayPlayer1"};
   var SetupPlayer2 = {ctor: "SetupPlayer2"};
   var SetupPlayer1 = {ctor: "SetupPlayer1"};
   ...
   model) {
      return function () {
         ...
         {case "GameOver": return model;
            case "PlayPlayer1":
            return function () {
                 var isGameOverResult = isGameOver(model);
                 return $Basics.fst(isGameOverResult) ? _U.replace([["state"
                                                                    ,GameOver($Basics.snd(isGameOverResult))]],
                 model) : function () {
                    switch (action.ctor)
                    {case "SetupShootColumn":
                       return _U.replace([["shootColumn"
                                          ,A2(toIntOrDefaultOrZero,
                                          action._0,
                                          model.shootColumn)]],
                         model);
                       case "SetupShootRow":
                       return _U.replace([["shootRow"
                                          ,A2(toIntOrDefaultOrZero,
                                          action._0,
                                          model.shootRow)]],
                         model);
                       ...
                       return function () {
                            ...
                            var shootResult = A2(guessShip,
                            A2($Matrix.location,
                            model.shootRow,
                            model.shootColumn),
                            model.player2.grid);
                            return $Basics.fst(shootResult) ? _U.replace([["player2"
                                                                          ,_U.replace([["grid"
                                                                                       ,$Basics.snd(shootResult)]],
                                                                          player)]
                                                                         ,["state"
                                                                          ,PlayPlayer2]],
                            model) : model;
                 ...
                 model) : function () {
                    ...
                    {case "SetupShootColumn":
                       ...
                       return function () {
                            ...
                            model.shootColumn),
                            model.player1.grid);
                            return $Basics.fst(shootResult) ? _U.replace([["player1"
                                                                          ,_U.replace([["grid"
                                                                                       ,$Basics.snd(shootResult)]],
                                                                          player)]
                                                                         ,["state"
            ...
            return function () {
                 ...
                 {case "AddShip":
                    return function () {
                         var grid = model.player1.grid;
                         var player = model.player1;
                         var ship = A2($Array.get,
                         action._0,
                         $Array.fromList(model.player1.ships));
                         return function () {
                            switch (ship.ctor)
                            {case "Just":
                               return function () {
                                    var addShipResult = A2(addShip,
                                    ship._0,
                                    grid);
                                    return _U.replace([["player1"
                                                       ,_U.replace([["grid"
                                                                    ,$Basics.snd(addShipResult)]
                                                                   ,["ships"
                                                                    ,A2($List.map,
                                                                    function (aShip) {
            ...
            return function () {
                 ...
                 {case "AddShip":
                    return function () {
                         var grid = model.player2.grid;
                         var player = model.player2;
                         var ship = A2($Array.get,
                         action._0,
                         $Array.fromList(model.player2.ships));
                         return function () {
                            switch (ship.ctor)
                            {case "Just":
                               return function () {
   ...
   _elm.Battleship.values = {_op: _op
                            ...
                            ,Player: Player
                            ,player: player
                            ,SetupPlayer1: SetupPlayer1
                            ,SetupPlayer2: SetupPlayer2
                            ,PlayPlayer1: PlayPlayer1
                            ,PlayPlayer2: PlayPlayer2
                            ,GameOver: GameOver
                            ,Game: Game
                            ,game: game
                            ,NoOp: NoOp
                            ,SetupShipRow: SetupShipRow
                            ,SetupShipColumn: SetupShipColumn
                            ,SetupShipOrientation: SetupShipOrientation
                            ,AddShip: AddShip
                            ,SetupShootRow: SetupShootRow
                            ,SetupShootColumn: SetupShootColumn
                            ,Shoot: Shoot
                            ,update: update
                            ...
                            ,trackingGridCellToString: trackingGridCellToString
                            ,trackingGridToString: trackingGridToString
                            ,allButOneShipAdded: allButOneShipAdded
                            ...
                            ,view: view
                            ,gridView: gridView
                            ,setupControlsView: setupControlsView
                            ,playControlsView: playControlsView
...
Elm.Matrix.make = function (_elm) {
   ...
   var initialize = F3(function (numRows,
   numCols,
   initial) {
   ...
   matrix) {
      ...
      A2($Array.get,row(loc),matrix),
      $Array.get(col(loc)));
   });
   var set = F3(function (loc,
   value,
   matrix) {
      return function () {
         ...
         {case "Just":
            return A3($Array.set,
              ...
              _v0._0),
              matrix);
            case "Nothing": return matrix;}
         _U.badCase($moduleName,
         "between lines 58 and 60");
      }();
   });
   var location = F2(function (v0,
   v1) {
      return {ctor: "_Tuple2"
             ,_0: v0
             ,_1: v1};
   ...
   var toString = F3(function (cellToString,
   padding,
   m) {
      return function () {
         var lineLength = (padding.width + 1) * colCount(m) + 1;
         return function (matrixString) {
         ...
         lineLength,
         "-"))($List.intersperse(A2($Array.repeat,
         lineLength,
         "-"))($Array.toList(mapWithLocation(F2(function (loc,
         unit) {
            return _U.eq(col(loc),
            0) ? A2($Basics._op["++"],
            "|",
            A2($Basics._op["++"],
            unit,
         ...
         padding.width,
         padding.delimit))(map(cellToString)(m)))))))));
      }();
   });
